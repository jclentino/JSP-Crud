package org.apache.jsp.vistas.usuario;
...
public final class registrar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <h1>¡Registrar nuevo usuario!</h1>\n");
      out.write("        <form action=\"\" method=\"post\">\n");
      out.write("            <label for=\"cedula\">Cédula:</label>\n");
      out.write("            <input type=\"text\" id=\"cedula\" name=\"cedula\" required><br>\n");
      out.write("            <label for=\"clave\">Contraseña:</label>\n");
      out.write("            <input type=\"password\" id=\"clave\" name=\"clave\" required><br>\n");
      out.write("            <label for=\"nombre\">Nombre:</label>\n");
      out.write("            <input type=\"text\" id=\"nombre\" name=\"nombre\" required><br>\n");
      out.write("            <label for=\"telefono\">Teléfono:</label>\n");
      out.write("            <input type=\"text\" id=\"telefono\" name=\"telefono\" required><br>\n");
      out.write("            <label for=\"email\">Email:</label>\n");
      out.write("            <input type=\"email\" id=\"email\" name=\"email\" required><br>\n");
      out.write("            <input type=\"submit\" value=\"Crear Usuario\">\n");
      out.write("        </form>\n");
      out.write("\n");
      out.write("    </body>\n");
      out.write("</html>\n");
